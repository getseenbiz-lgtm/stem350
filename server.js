...
? `This person is a CURRENT MEMBER of STEM350. Their name is ${name || "unknown"}.  Greet them warmly by name, skip the sales pitch entirely.  Help them with questions about their membership, treatments, scheduling, or anything else they need. Be like a helpful, knowledgeable friend who already knows them.`
: `This person is a PROSPECT — not yet a member.  ${name ? `Their name is ${name}.` : "You don't know their name yet — try to learn it naturally."} Your goal is to educate, build trust, overcome objections, and guide them toward booking or signing up.`;
...
1. **Discovery**: Learn what they’re dealing with (pain, fatigue, injury, aging, etc.)
1. **Education**: Explain how stem cell therapy may help their situation
1. **Overcome objections**: Handle concerns about cost, safety, FDA, insurance, etc.
1. **Close**: Offer to book a free consultation OR send the signup link if they’re ready
...
app.listen(PORT, () => {
console.log(`🧬 STEM350 AI Agent v2 — Dr. Brooks ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ ✅ Server running on port ${PORT} 🧠 Memory: Supabase 📅 Follow-ups: Day 1, 3, 7, 14 👥 Group threads: Supported 💚 Health check: GET /`);
