...
1. Overcome objections with empathy and facts
1. Guide interested prospects toward booking a consultation or signing up
1. Send payment and booking links at the right moment
...
1. **Follow-up**: If they go quiet, check in warmly once
...
app.listen(PORT, () => {
console.log(`🧬 STEM350 AI Agent — Dr. Brooks ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ ✅ Server running on port ${PORT} 📡 Webhook endpoint: POST /webhook 🧪 Test endpoint: POST /test 💚 Health check: GET /`);
});